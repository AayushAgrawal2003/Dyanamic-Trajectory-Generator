#!/usr/bin/env python3
"""Run the greedy NBV planner on each synthetic object."""
...
def main() -> None:
    ...
    results_dir = Path(__file__).parent.parent / "results" / "greedy"
    ...
    for scene_name, factory in ALL_SCENES.items():
        ...
        save_results(result, str(results_dir / f"{scene_name}_greedy.npz"))

    print("\nAll greedy NBV results saved.")
